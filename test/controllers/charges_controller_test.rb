...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference("Charge.count") do
      post charges_url, params: { charge: { amount: @charge.amount, error_message: @charge.error_message, payment_method: @charge.payment_method, response: @charge.response, status: @charge.status, uid: @charge.uid } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { amount: @charge.amount, error_message: @charge.error_message, payment_method: @charge.payment_method, response: @charge.response, status: @charge.status, uid: @charge.uid } }
